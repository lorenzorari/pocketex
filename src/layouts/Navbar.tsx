      ...
      <nav className="flex items-center justify-between">
        <Link to="/" className="inline-flex items-center gap-2 text-2xl font-bold">
          <picture className="size-8">
            <Logo
              className={cn('hover:animate-wiggle', {
                'fill-white': isHome,
              })}
            />
          </picture>
        ...
        <ul className={cn('flex items-center gap-4', { 'text-white': isHome })}>
          <li>
            <Link to="/explore" className="text-sm underline-offset-4 hover:underline">
              Explore
            </Link>
          </li>
          <li>
            <Link target="_blank" to={{ pathname: GITHUB_LINK }} className="text-sm underline-offset-4 hover:underline">
              <IconBrandGithub
